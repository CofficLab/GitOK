...
/// 将内核场景 Provider 收窄成 GitBranchStatus 插件所需的能力。
@MainActor
final class GitBranchStatusSceneCapabilityAdapter: GitBranchStatusSceneCapability {
