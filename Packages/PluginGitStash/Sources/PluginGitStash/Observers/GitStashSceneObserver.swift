...
/// Git Stash 插件的场景观察者。
@MainActor
final class GitStashSceneObserver {
    private weak var viewModel: WorkspaceSceneVisibilityViewModel?
    private let capability: any GitStashSceneCapability
    private var handle: (any WorkspaceSceneObserverHandle)?

    init(capability: any GitStashSceneCapability, viewModel: WorkspaceSceneVisibilityViewModel) {
