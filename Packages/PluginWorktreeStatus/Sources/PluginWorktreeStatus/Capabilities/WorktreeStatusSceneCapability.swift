...
/// 将内核场景 Provider 收窄成 WorktreeStatus 插件所需的能力。
@MainActor
final class WorktreeStatusSceneCapabilityAdapter: WorktreeStatusSceneCapability {
