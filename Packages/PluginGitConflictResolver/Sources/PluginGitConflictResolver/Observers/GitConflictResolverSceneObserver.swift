...
@MainActor
final class GitConflictResolverSceneObserver {
    private weak var viewModel: WorkspaceSceneVisibilityViewModel?
    private let capability: any GitConflictResolverSceneCapability
    private var handle: (any WorkspaceSceneObserverHandle)?

    init(capability: any GitConflictResolverSceneCapability, viewModel: WorkspaceSceneVisibilityViewModel) {
