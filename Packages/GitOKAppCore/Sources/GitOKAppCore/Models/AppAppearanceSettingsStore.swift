...
/// 应用外观设置存储
@MainActor
public class AppAppearanceSettingsStore: ObservableObject {
    public static let shared = AppAppearanceSettingsStore()
    ...
    /// 布局密度
    public enum LayoutDensity: String, CaseIterable, Identifiable {
