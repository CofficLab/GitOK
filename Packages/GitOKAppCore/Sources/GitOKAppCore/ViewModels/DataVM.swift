...
@MainActor
public class DataVM: NSObject, ObservableObject, SuperLog {
    // MARK: - Properties

    @Published public var projects: [Project] = []
    @Published public var commit: GitCommit? = nil
    @Published public private(set) var branch: GitBranch? = nil
    @Published public var activityStatus: String? = nil
    ...
    public init(projects: [Project], repoManager: RepoManager) {
...
extension DataVM {
     ...
     * @param repo 项目仓库实例
     */
    public func moveProjects(from source: IndexSet, to destination: Int, using repo: any ProjectRepoProtocol) {
     ...
     * @param repo 项目仓库实例
     */
    public func refreshProjects(using repo: any ProjectRepoProtocol) {
        do {
     ...
     */
    @discardableResult
    public func addProject(url: URL, using repo: any ProjectRepoProtocol) -> Project? {
        do {
     ...
     * @param repo 项目仓库实例
     */
    public func deleteProject(_ project: Project, using repo: any ProjectRepoProtocol) {
...
extension DataVM {
     ...
     * @throws Git操作异常
     */
    public func setBranch(_ branch: GitBranch?, project: Project?) throws {
    ...
    public func refreshCurrentBranch(project: Project?, isGitRepository: Bool, reason: String) {
