...
/// 将内核场景 Provider 收窄成 GitAutoPush 插件所需的能力。
@MainActor
final class GitAutoPushSceneCapabilityAdapter: GitAutoPushSceneCapability {
