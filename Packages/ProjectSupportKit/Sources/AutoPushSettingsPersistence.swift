...
public enum AutoPushSettingsPersistence {
    public static let settingsDirName = "settings"
    public static let stateFileName = "auto_push_settings.json"
    public static let tmpFileName = "auto_push_settings.tmp"
    ...
    public static func makeKey(projectPath: String, branchName: String) -> String {
        "\(projectPath)://\(branchName)"
    }

    public static func parseKey(_ key: String) -> (projectPath: String, branchName: String)? {
        let components = key.components(separatedBy: "://")
        guard components.count == 2 else { return nil }
        return (projectPath: components[0], branchName: components[1])
    }

    public static func updatedSettings(
    ...
    public static func updatedLastPushedDate(
        settings: [String: ProjectBranchAutoPushConfig],
        projectPath: String,
        branchName: String,
        now: Date
    ...
    public static func settingsByRemovingConfig(
        settings: [String: ProjectBranchAutoPushConfig],
        projectPath: String,
        branchName: String
    ) -> [String: ProjectBranchAutoPushConfig] {
    ...
    public static func settingsByRemovingProject(
        settings: [String: ProjectBranchAutoPushConfig],
        projectPath: String
    ) -> [String: ProjectBranchAutoPushConfig] {
    ...
    public static func configs(
        forProject projectPath: String,
        in settings: [String: ProjectBranchAutoPushConfig]
    ) -> [ProjectBranchAutoPushConfig] {
        settings.values.filter { $0.projectPath == projectPath }
    }

    public static func enabledConfigs(in settings: [String: ProjectBranchAutoPushConfig]) -> [ProjectBranchAutoPushConfig] {
