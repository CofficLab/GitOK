...
/// 将内核场景 Provider 收窄成 CommitStatusBar 插件所需的能力。
@MainActor
final class CommitStatusBarSceneCapabilityAdapter: CommitStatusBarSceneCapability {
