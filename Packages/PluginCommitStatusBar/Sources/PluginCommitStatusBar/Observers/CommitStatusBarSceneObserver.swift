...
/// Commit Status Bar 插件的场景观察者。
@MainActor
final class CommitStatusBarSceneObserver {
    private weak var viewModel: WorkspaceSceneVisibilityViewModel?
    private let capability: any CommitStatusBarSceneCapability
    private var handle: (any WorkspaceSceneObserverHandle)?

    init(capability: any CommitStatusBarSceneCapability, viewModel: WorkspaceSceneVisibilityViewModel) {
