...
/// 将内核场景 Provider 收窄成 FileInfo 插件所需的能力。
@MainActor
final class FileInfoSceneCapabilityAdapter: FileInfoSceneCapability {
