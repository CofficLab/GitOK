...
/// 将内核场景 Provider 收窄成 CommitForm 插件所需的能力。
@MainActor
final class CommitFormSceneCapabilityAdapter: CommitFormSceneCapability {
