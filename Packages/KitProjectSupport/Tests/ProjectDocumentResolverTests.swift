import Foundation
import XCTest
@testable import KitProjectSupport
...
final class ProjectDocumentResolverTests: XCTestCase {
    func testReadReadmeContentUsesFirstMatchingCandidate() throws {
        ...
        XCTAssertEqual(try ProjectDocumentResolver.readReadmeContent(in: repo.url), "preferred\n")
    }
    ...
    func testReadGitignoreContentReadsRootFile() throws {
        ...
        XCTAssertEqual(try ProjectDocumentResolver.readGitignoreContent(in: repo.url), "DerivedData/\n")
    }
    ...
    func testReadLicenseContentUsesFirstMatchingCandidate() throws {
        ...
        XCTAssertEqual(try ProjectDocumentResolver.readLicenseContent(in: repo.url), "preferred\n")
    }
