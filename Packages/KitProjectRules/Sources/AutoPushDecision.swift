...
public enum AutoPushCheckDecision: Equatable {
    case skip(AutoPushSkipReason)
    case shouldPush(branchName: String)
}

public enum AutoPushSkipReason: Equatable {
    case missingBranch
    case disabled
...
public enum AutoPushExecutionDecision: Equatable {
    case skipAlreadyPushing
    case markIdle
    case push
}

public enum AutoPushDecision {
