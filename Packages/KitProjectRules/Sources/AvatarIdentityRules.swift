...
public enum AvatarIdentityRules {
    public static let botAvatarCache: [String: String] = [
    ...
    public static func cacheKey(name: String, email: String) -> String {
        let normalizedEmail = normalizeEmail(email)
        return normalizedEmail.isEmpty ? name : normalizedEmail
    }

    public static func gravatarURL(email: String, size: Int = 64) -> URL {
    ...
    public static func botAvatarURL(email: String, name: String) -> URL? {
        let normalizedEmail = normalizeEmail(email)
