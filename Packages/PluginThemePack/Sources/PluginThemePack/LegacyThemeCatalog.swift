...
public enum LegacyThemeCatalog {
    ...
    public static let lumi = LumiTheme(
        id: "lumi",
        sortOrder: 1000,
        displayName: LumiPluginLocalization.string("Lumi", bundle: .module),
        compactName: LumiPluginLocalization.string("Lumi", bundle: .module),
        description: LumiPluginLocalization.string("Forest Ink · low-saturation warm palette, adapts to system light and dark", bundle: .module),
    ...
    public static let midnight = LumiTheme(
        id: "midnight",
        sortOrder: 1010,
        displayName: LumiPluginLocalization.string("Midnight Blue", bundle: .module),
        compactName: LumiPluginLocalization.string("Midnight", bundle: .module),
        description: LumiPluginLocalization.string("Deep midnight blue, mysterious and serene", bundle: .module),
    ...
    public static let sky = LumiTheme(
        id: "sky",
        sortOrder: 1020,
        displayName: LumiPluginLocalization.string("Sky", bundle: .module),
        compactName: LumiPluginLocalization.string("Sky", bundle: .module),
        description: LumiPluginLocalization.string("Between clear sky and night, follows the system appearance", bundle: .module),
    ...
    public static let aurora = LumiTheme(
        id: "aurora",
        sortOrder: 1030,
        displayName: LumiPluginLocalization.string("Aurora Purple", bundle: .module),
        compactName: LumiPluginLocalization.string("Aurora", bundle: .module),
        description: LumiPluginLocalization.string("Gorgeous aurora purple, dreamy and elegant", bundle: .module),
        iconName: "sparkles",
    ...
    public static let nebula = LumiTheme(
        id: "nebula",
        sortOrder: 1040,
        displayName: LumiPluginLocalization.string("Nebula Pink", bundle: .module),
        compactName: LumiPluginLocalization.string("Nebula", bundle: .module),
        description: LumiPluginLocalization.string("Romantic nebula pink, soft and warm", bundle: .module),
    ...
    public static let void = LumiTheme(
        id: "void",
        sortOrder: 1050,
        displayName: LumiPluginLocalization.string("Void Black", bundle: .module),
        compactName: LumiPluginLocalization.string("Void", bundle: .module),
        description: LumiPluginLocalization.string("Pure void black, deep and mysterious", bundle: .module),
    ...
    public static let spring = LumiTheme(
        id: "spring",
        sortOrder: 1060,
        displayName: LumiPluginLocalization.string("Spring Bud Green", bundle: .module),
        compactName: LumiPluginLocalization.string("Spring", bundle: .module),
        description: LumiPluginLocalization.string("Fresh spring buds awakening, crisp and gentle", bundle: .module),
        iconName: "leaf.fill",
    ...
    public static let summer = LumiTheme(
        id: "summer",
        sortOrder: 1070,
        displayName: LumiPluginLocalization.string("Midsummer Blue", bundle: .module),
        compactName: LumiPluginLocalization.string("Summer", bundle: .module),
        description: LumiPluginLocalization.string("Blazing sun and sea breeze, clear and bright", bundle: .module),
    ...
    public static let autumn = LumiTheme(
        id: "autumn",
        sortOrder: 1080,
        displayName: LumiPluginLocalization.string("Autumn Maple Orange", bundle: .module),
        compactName: LumiPluginLocalization.string("Autumn", bundle: .module),
        description: LumiPluginLocalization.string("Slight red maple shade, warm and profound", bundle: .module),
        iconName: "wind",
    ...
    public static let winter = LumiTheme(
        id: "winter",
        sortOrder: 1090,
        displayName: LumiPluginLocalization.string("Frost Winter White", bundle: .module),
        compactName: LumiPluginLocalization.string("Winter", bundle: .module),
        description: LumiPluginLocalization.string("Frost and snow glow, calm and serene", bundle: .module),
        iconName: "snowflake",
    ...
    public static let github = LumiTheme(
        id: "github",
        sortOrder: 1100,
        displayName: LumiPluginLocalization.string("GitHub", bundle: .module),
        compactName: LumiPluginLocalization.string("GitHub", bundle: .module),
        description: LumiPluginLocalization.string("Inspired by GitHub's dark theme, deep and professional", bundle: .module),
    ...
    public static let orchard = LumiTheme(
        id: "orchard",
        sortOrder: 1110,
        displayName: LumiPluginLocalization.string("Orchard Red", bundle: .module),
        compactName: LumiPluginLocalization.string("Orchard", bundle: .module),
        description: LumiPluginLocalization.string("Fruity sweetness, bright and vivid", bundle: .module),
        iconName: "apple.logo",
    ...
    public static let mountain = LumiTheme(
        id: "mountain",
        sortOrder: 1120,
        displayName: LumiPluginLocalization.string("Mountain Mist Gray", bundle: .module),
        compactName: LumiPluginLocalization.string("Mountain", bundle: .module),
        description: LumiPluginLocalization.string("Steady stone gray, distant pine shadows", bundle: .module),
    ...
    public static let vscodeAuto = LumiTheme(
        id: "vscode-auto",
        sortOrder: 1130,
        displayName: LumiPluginLocalization.string("VS Code", bundle: .module),
        compactName: LumiPluginLocalization.string("VSCode", bundle: .module),
        description: LumiPluginLocalization.string("Automatically switches VS Code light/dark palette with the system appearance", bundle: .module),
        iconName: "terminal",
    ...
    public static let vscodeDark = LumiTheme(
        id: "vscode-dark",
        sortOrder: 1140,
        displayName: LumiPluginLocalization.string("VS Code Dark", bundle: .module),
        compactName: LumiPluginLocalization.string("VSCode Dark", bundle: .module),
        description: LumiPluginLocalization.string("Classic dark IDE palette of Visual Studio Code Dark+", bundle: .module),
    ...
    public static let vscodeLight = LumiTheme(
        id: "vscode-light",
        sortOrder: 1150,
        displayName: LumiPluginLocalization.string("VS Code Light", bundle: .module),
        compactName: LumiPluginLocalization.string("VSCode Light", bundle: .module),
        description: LumiPluginLocalization.string("Classic light IDE palette of Visual Studio Code Light+", bundle: .module),
        iconName: "terminal",
        iconColor: ThemeHexPair(hex: "007ACC"),
    ...
    public static let river = LumiTheme(
        id: "river",
        sortOrder: 1160,
        displayName: LumiPluginLocalization.string("River Teal", bundle: .module),
        compactName: LumiPluginLocalization.string("River", bundle: .module),
        description: LumiPluginLocalization.string("Clear ripples, pure and translucent", bundle: .module),
        iconName: "drop.fill",
    ...
    public static let oneDark = LumiTheme(
        id: "one-dark",
        sortOrder: 1170,
        displayName: LumiPluginLocalization.string("One Dark", bundle: .module),
        compactName: LumiPluginLocalization.string("One Dark", bundle: .module),
        description: LumiPluginLocalization.string("Classic Atom One Dark palette, comfortable and balanced", bundle: .module),
    ...
    public static let dracula = LumiTheme(
        id: "dracula",
        sortOrder: 1180,
        displayName: LumiPluginLocalization.string("Dracula", bundle: .module),
        compactName: LumiPluginLocalization.string("Dracula", bundle: .module),
        description: LumiPluginLocalization.string("Classic Dracula Official dark palette, high contrast and striking", bundle: .module),
        iconName: "moon.stars.fill",
