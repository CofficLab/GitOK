...
public enum LegacyThemeCatalog {
    ...
    public static let lumi = LumiTheme(
        ...
        displayName: "Lumi",
        compactName: "Lumi",
        description: "Forest Ink · low-saturation warm palette, adapts to system light and dark",
    ...
    public static let midnight = LumiTheme(
        ...
        description: "Deep midnight blue, mysterious and serene",
    ...
    public static let sky = LumiTheme(
        ...
        displayName: "Sky",
        compactName: "Sky",
        description: "Between clear sky and night, follows the system appearance",
    ...
    public static let aurora = LumiTheme(
        id: "aurora",
        sortOrder: 1030,
        displayName: "Aurora Purple",
        compactName: "Aurora",
        description: "Gorgeous aurora purple, dreamy and elegant",
        iconName: "sparkles",
    ...
    public static let nebula = LumiTheme(
        id: "nebula",
        sortOrder: 1040,
        displayName: "Nebula Pink",
        compactName: "Nebula",
        description: "Romantic nebula pink, soft and warm",
    ...
    public static let void = LumiTheme(
        ...
        compactName: "Void",
        description: "Pure void black, deep and mysterious",
    ...
    public static let spring = LumiTheme(
        id: "spring",
        sortOrder: 1060,
        displayName: "Spring Bud Green",
        compactName: "Spring",
        description: "Fresh spring buds awakening, crisp and gentle",
        iconName: "leaf.fill",
    ...
    public static let summer = LumiTheme(
        id: "summer",
        sortOrder: 1070,
        displayName: "Midsummer Blue",
        compactName: "Summer",
        description: "Blazing sun and sea breeze, clear and bright",
    ...
    public static let autumn = LumiTheme(
        id: "autumn",
        sortOrder: 1080,
        displayName: "Autumn Maple Orange",
        compactName: "Autumn",
        description: "Slight red maple shade, warm and profound",
        iconName: "wind",
    ...
    public static let winter = LumiTheme(
        id: "winter",
        sortOrder: 1090,
        displayName: "Frost Winter White",
        compactName: "Winter",
        description: "Frost and snow glow, calm and serene",
        iconName: "snowflake",
    ...
    public static let github = LumiTheme(
        ...
        displayName: "GitHub",
        compactName: "GitHub",
        description: "Inspired by GitHub's dark theme, deep and professional",
    ...
    public static let orchard = LumiTheme(
        id: "orchard",
        sortOrder: 1110,
        displayName: "Orchard Red",
        compactName: "Orchard",
        description: "Fruity sweetness, bright and vivid",
        iconName: "apple.logo",
    ...
    public static let mountain = LumiTheme(
        id: "mountain",
        sortOrder: 1120,
        displayName: "Mountain Mist Gray",
        compactName: "Mountain",
        description: "Steady stone gray, distant pine shadows",
    ...
    public static let vscodeAuto = LumiTheme(
        ...
        displayName: "VS Code",
        compactName: "VSCode",
        description: "Automatically switches VS Code light/dark palette with the system appearance",
        iconName: "terminal",
    ...
    public static let vscodeDark = LumiTheme(
        ...
        compactName: "VSCode Dark",
        description: "Classic dark IDE palette of Visual Studio Code Dark+",
    ...
    public static let vscodeLight = LumiTheme(
        ...
        compactName: "VSCode Light",
        description: "Classic light IDE palette of Visual Studio Code Light+",
        iconName: "terminal",
        iconColor: ThemeHexPair(hex: "007ACC"),
    ...
    public static let river = LumiTheme(
        id: "river",
        sortOrder: 1160,
        displayName: "River Teal",
        compactName: "River",
        description: "Clear ripples, pure and translucent",
        iconName: "drop.fill",
    ...
    public static let oneDark = LumiTheme(
        ...
        description: "Classic Atom One Dark palette, comfortable and balanced",
    ...
    public static let dracula = LumiTheme(
        ...
        displayName: "Dracula",
        compactName: "Dracula",
        description: "Classic Dracula Official dark palette, high contrast and striking",
        iconName: "moon.stars.fill",
