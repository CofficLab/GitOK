...
/// .gitignore 文档内容加载骨架：模拟等宽文本行，
/// 保持文档查看器在读取文件时的内容密度和滚动区域高度。
struct GitIgnoreSkeletonView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ForEach(0..<lineCount, id: \.self) { index in
                GitIgnoreSkeletonLine(index: index)
            }
        }
...
private struct GitIgnoreSkeletonLine: View {
    @LumiTheme private var theme
