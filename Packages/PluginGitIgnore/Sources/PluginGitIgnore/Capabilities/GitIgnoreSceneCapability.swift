...
/// 将内核场景 Provider 收窄成 GitIgnore 插件所需的能力。
@MainActor
final class GitIgnoreSceneCapabilityAdapter: GitIgnoreSceneCapability {
