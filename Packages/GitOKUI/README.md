...
在你的 `Package.swift` 中添加 GitOKUI 依赖：
...
2. 选择 **Local Package** 并导航到 GitOKUI 目录
3. 添加到你的项目目标
...
GitOKUI 采用 MIT 许可证 - 详见 [LICENSE](LICENSE) 文件
