...
extension DesignTokens {
    /// Motion tokens keep interaction timing consistent across GitOKUI.
    enum Motion {
        ...
        static func enabled(_ animation: Animation, preference: GitOKMotionPreference) -> Animation? {
            preference.allowsMotion ? animation : nil
        }

        static func listEnabled(_ animation: Animation, preference: GitOKMotionPreference) -> Animation? {
...
public enum GitOKMotion {
    ...
    public static func enabled(_ animation: Animation, preference: GitOKMotionPreference) -> Animation? {
        DesignTokens.Motion.enabled(animation, preference: preference)
    }

    public static func listEnabled(_ animation: Animation, preference: GitOKMotionPreference) -> Animation? {
