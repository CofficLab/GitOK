...
/// Commit Detail 插件的场景观察者。
@MainActor
final class CommitDetailSceneObserver {
    private weak var viewModel: WorkspaceSceneVisibilityViewModel?
    private let capability: any CommitDetailSceneCapability
    private var handle: (any WorkspaceSceneObserverHandle)?

    init(capability: any CommitDetailSceneCapability, viewModel: WorkspaceSceneVisibilityViewModel) {
