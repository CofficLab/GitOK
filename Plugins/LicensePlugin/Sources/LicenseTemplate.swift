...
enum LicenseTemplate: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .mit: return LicensePluginLocalization.string("MIT License")
        case .apache2: return LicensePluginLocalization.string("Apache License 2.0")
        case .gpl3: return LicensePluginLocalization.string("GPL v3")
        }
    }
