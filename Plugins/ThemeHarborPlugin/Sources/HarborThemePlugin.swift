...
public enum HarborThemePlugin: GitOKPlugin {
    public static let metadata = GitOKPluginMetadata(id: "ThemeHarborPlugin", displayName: HarborThemePluginLocalization.string("Harbor Theme"), description: HarborThemePluginLocalization.string("Deep blue water theme"), iconName: "network", order: 337, policy: .alwaysOn, tableName: HarborThemePluginLocalization.table)
