...
final class FileInfoPluginTests: XCTestCase {
    ...
    func testLocalizationCatalogIsPackaged() {
        XCTAssertNotNil(PluginFileInfoLocalization.bundle.url(forResource: "FileInfo", withExtension: "xcstrings"))
        XCTAssertFalse(PluginFileInfoLocalization.string("File Actions").isEmpty)
        XCTAssertFalse(PluginFileInfoLocalization.string("Copy Path").isEmpty)
    }
