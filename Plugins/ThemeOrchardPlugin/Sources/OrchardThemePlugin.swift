...
public struct OrchardThemePlugin: GitOKPlugin {
    public static let metadata = GitOKPluginMetadata(id: "ThemeOrchardPlugin", displayName: "Orchard Theme", description: "Earthy amber dark theme", iconName: "tray.full", order: 128, policy: .disabled, tableName: "Localizable")
