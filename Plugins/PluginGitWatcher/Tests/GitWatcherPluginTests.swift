import Foundation
@testable import PluginGitWatcher
import Testing

@Suite("PluginGitWatcher")
struct GitWatcherPluginTests {
    ...
    func metadata() {
        ...
        #expect(GitWatcherPlugin.metadata.defaultEnabled == true)
    ...
    private func temporaryDirectory() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("PluginGitWatcherTests-\(UUID().uuidString)", isDirectory: true)
