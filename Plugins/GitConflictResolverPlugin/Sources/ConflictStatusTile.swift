...
public struct ConflictStatusTile: View {
    ...
    public var body: some View {
        AppStatusBarTile(
            ...
            if isLoading {
                ...
                Text(isMerging ? GitConflictResolverPluginLocalization.string("Conflicts \(conflictCount)") : GitConflictResolverPluginLocalization.string("Merge OK"))
    ...
    private var helpText: String {
        if isMerging {
            return String(
                format: GitConflictResolverPluginLocalization.string("There are %d conflicted files. Click to resolve them."),
                conflictCount
            )
        }
        return GitConflictResolverPluginLocalization.string("No merge conflicts")
    }
