...
final class OpenTerminalPluginTests: XCTestCase {
    ...
    func testLocalizationCatalogIsPackaged() {
        XCTAssertNotNil(PluginOpenTerminalLocalization.bundle.url(forResource: "OpenTerminal", withExtension: "xcstrings"))
        XCTAssertFalse(PluginOpenTerminalLocalization.string("Open Terminal").isEmpty)
        XCTAssertFalse(PluginOpenTerminalLocalization.string("Open in Terminal").isEmpty)
    }
