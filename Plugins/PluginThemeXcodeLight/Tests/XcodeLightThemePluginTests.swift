import XCTest
import GitOKCoreKit
@testable import PluginThemeXcodeLight
...
final class XcodeLightThemePluginTests: XCTestCase {
    ...
    func testThemeContributionIsAvailable() {
        let contributions = XcodeLightThemePlugin.shared.themeContributions()
    ...
    func testLocalizationCatalogIsPackaged() {
        let resourceURL = Bundle.module.url(forResource: "ThemeXcodeLight", withExtension: "xcstrings")
