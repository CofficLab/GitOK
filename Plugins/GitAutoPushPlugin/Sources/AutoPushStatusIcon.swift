...
public struct AutoPushStatusIcon: View {
    ...
    public var body: some View {
        ...
        .help(isAutoPushEnabled ? GitAutoPushPluginLocalization.string("Auto-push is enabled - Click to manage") : GitAutoPushPluginLocalization.string("Auto-push is disabled - Click to configure"))
