...
public struct GitPushButton: View {
    ...
    private var pushTitle: String {
        trackingStatus.hasUpstream
            ? PluginGitPushLocalization.string("Push origin")
            : PluginGitPushLocalization.string("Publish branch")
    }
    ...
    private func showError(_ error: Error) {
        let alert = NSAlert()
        alert.messageText = PluginGitPushLocalization.string("Git sync failed")
...
public enum GitPushPrimaryAction: Equatable, Sendable {
    ...
    var title: String {
        switch self {
        case .fetch:
            PluginGitPushLocalization.string("Fetch origin")
        case .pull:
            PluginGitPushLocalization.string("Pull origin")
        case .push:
            PluginGitPushLocalization.string("Push origin")
        }
    }
    ...
    var help: String {
        switch self {
        case .fetch:
            PluginGitPushLocalization.string("Branch is up to date, click Fetch to check for remote updates")
        case .pull:
            PluginGitPushLocalization.string("New commits on remote, click Pull; Fetch or Push available in menu")
        case .push:
            PluginGitPushLocalization.string("Commits ready to push")
        }
    }
}
