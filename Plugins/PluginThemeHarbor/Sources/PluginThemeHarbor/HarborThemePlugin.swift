...
public struct HarborThemePlugin: GitOKPlugin {
    public static let metadata = GitOKPluginMetadata(id: "ThemeHarborPlugin", displayName: "Harbor Theme", description: "Deep blue water theme", iconName: "network", order: 127, policy: .alwaysOn, tableName: "ThemeHarbor")
