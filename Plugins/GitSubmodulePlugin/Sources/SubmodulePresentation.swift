...
public enum SubmodulePresentation {
    ...
    public static func statusText(for status: GitRepositoryCLI.GitSubmodule.Status) -> String {
        switch status {
        case .initialized:
            return GitSubmodulePluginLocalization.string("Initialized")
        case .uninitialized:
            return GitSubmodulePluginLocalization.string("Uninitialized")
        case .modified:
            return GitSubmodulePluginLocalization.string("HEAD differs from index")
        case .conflicted:
            return GitSubmodulePluginLocalization.string("Conflicted")
        }
    }
