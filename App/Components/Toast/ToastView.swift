...
struct ToastContainerView: View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                ForEach(toastManager.toasts) { toast in
                    toastViewForDisplayMode(toast, in: geometry)
                }
            }
    ...
    @ViewBuilder
    private func toastViewForDisplayMode(_ toast: ToastModel, in geometry: GeometryProxy) -> some View {
...
private extension View {
    @ViewBuilder
    func positioned(for displayMode: ToastDisplayMode, in geometry: GeometryProxy) -> some View {
        switch displayMode {
        case .overlay:
            self
