...
struct ReleaseNotesSettingView: View {
    ...
    private var currentVersionSection: some View {
        MagicSettingSection(title: "当前版本", titleAlignment: .leading) {
            VStack(spacing: 0) {
                MagicSettingRow(
                    title: "版本",
    ...
    private var updateSection: some View {
        MagicSettingSection(title: "更新检查", titleAlignment: .leading) {
            VStack(spacing: 0) {
                HStack(spacing: 12) {
    ...
    private var releaseNotesSection: some View {
        MagicSettingSection(title: "版本更新说明", titleAlignment: .leading) {
            VStack(spacing: 0) {
                releaseLinkRow(
                    title: "最新版本说明",
...
#Preview("Release Notes") {
    SettingView(defaultTab: .releaseNotes)
        .inRootView()
